...
identifiers for the protein with the Gene Symbol FGG. In acc2007 the identifier
Accession ID is 'IPI00877703.1' and the local group identifier is 14. This
...
# Translation
```{r}
translated <- applyDict(dict, input = list(acc2007, acc2067), out.dir = NULL)
```
...
The resulting protein group code for FGG is now 10 and consists of a much
...
```{r}
translated2 <- applyDict(dict2, input = list(acc2007, acc2067, acc2047,
